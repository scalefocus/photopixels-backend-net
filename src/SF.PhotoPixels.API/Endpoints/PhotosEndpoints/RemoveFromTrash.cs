    ...
    .WithActionResult<StorePhotoResponse>
{
    ...
    public override async Task<ActionResult<StorePhotoResponse>> HandleAsync([FromBody] RemoveFromTrashObjectRequest request, CancellationToken cancellationToken = default)
    {
